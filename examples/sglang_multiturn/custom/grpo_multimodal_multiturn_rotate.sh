...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen2_5_vl_3b_custom_with_tool_rotate-batch_128' \
    ...
    actor_rollout_ref.rollout.multi_turn.tool_config_path="$PROJECT_DIR/examples/sglang_multiturn/config/tool_config/custom_rotate_tool_config.yaml"